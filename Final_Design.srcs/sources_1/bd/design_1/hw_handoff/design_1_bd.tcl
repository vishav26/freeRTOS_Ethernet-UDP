...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Fan_Output [ create_bd_port -dir O Fan_Output ]
  set Fan_Signal [ create_bd_port -dir I Fan_Signal ]
  ...
  # Create instance: My_Output_0, and set properties
  set My_Output_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:My_Output:1.0 My_Output_0 ]
...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins My_Output_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins My_Counter_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net Fan_Signal_1 [get_bd_ports Fan_Signal] [get_bd_pins My_Counter_0/Fan_Signal]
  connect_bd_net -net My_Output_0_Fan_Output [get_bd_ports Fan_Output] [get_bd_pins My_Output_0/Fan_Output]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins My_Counter_0/s00_axi_aclk] [get_bd_pins My_Output_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins My_Counter_0/s00_axi_aresetn] [get_bd_pins My_Output_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs My_Counter_0/S00_AXI/S00_AXI_reg] SEG_My_Counter_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs My_Output_0/S00_AXI/S00_AXI_reg] SEG_My_Output_0_S00_AXI_reg
...
preplace port Fan_Output -pg 1 -y 90 -defaultsOSRD
preplace port Fan_Signal -pg 1 -y 50 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 320 -defaultsOSRD
preplace inst My_Output_0 -pg 1 -lvl 3 -y 90 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 130 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -y 160 -defaultsOSRD
preplace inst My_Counter_0 -pg 1 -lvl 3 -y 220 -defaultsOSRD
...
preplace netloc My_Output_0_Fan_Output 1 3 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 440
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 460 280 740
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 250 410
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 720
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 320 NJ 320 NJ
preplace netloc Fan_Signal_1 1 0 3 NJ 50 420J 270 750J
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 70 430 290 730
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 720
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 450
levelinfo -pg 1 0 220 590 880 1040 -top 0 -bot 530
",
}
