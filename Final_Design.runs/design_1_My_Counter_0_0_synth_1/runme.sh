...
HD_PWD='C:/Studienarbeit_Final/Final_Design/Final_Design.runs/design_1_My_Counter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_My_Counter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_My_Counter_0_0.tcl
